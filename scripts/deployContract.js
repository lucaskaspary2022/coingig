...
module.exports.deployContract = async (address) => {
  ...
  const Greeter = await ethers.getContractFactory("Verifier", wallet);
  ...
  // const greeter = await Greeter.deploy("0xDe871bD3e8dd00C3f85AeA3889ee8A477e02Ee3c");
  const greeter = await Greeter.deploy(address);
